...
| :-----------------------------: | ------------------------------------------------------------------------------------------------------------------------ | :--------------: |
|              4.0.0              | 1. Simplified backend data processing by aligning with Grafana SDK's DataFrame best practices. <br> 2. Fixed alert tag extraction for queries with grouped dimensions.  | 3.3.7.0 or later |
