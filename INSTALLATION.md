...
| :-----------------------------: | ------------------------------------------------------------------------------------------------------------------------ | :--------------: |
|              4.0.2              | 1. Added Stream Computing observability panels to TDinsightV3. <br> 2. Added Stream Failed / Stream Recalc Failed predefined alert rules (require TDengine v3.4.2.7 or later). | 3.3.7.0 or later |
